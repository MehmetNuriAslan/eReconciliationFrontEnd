...
export class CurrencyAccountPipe implements PipeTransform {
  ...
  transform(value: any[], searchString:string) {
    ...
    return value.filter(i=>{
      ...
      // const taxDepartment =i.taxDepartment!=null? i.taxDepartment.toLowerCase().toString().includes(searchString):""
      // const taxIdNumber =i.taxIdNumber!=null?i.taxIdNumber.toLowerCase().toString().includes(searchString):""
      // const identityNumber =i.identityNumber!=null?i.identityNumber.toLowerCase().toString().includes(searchString):""
      const authorized =i.authorized.toLowerCase().toString().includes(searchString.toLowerCase())

      return (code+name+address+authorized)//)
    })
  }
